import { Info, AlertTriangle, Lightbulb, ArrowRightLeft, Leaf } from 'lucide-react';

interface InfoBoxProps {
  type?: 'info' | 'warning' | 'tip' | 'angular' | 'spring';
  title?: string;
...
const config = {
  ...
  angular: {
    ...
    defaultTitle: 'Comparación con Angular/TypeScript',
  },
  spring: {
    icon: Leaf,
    bg: 'bg-spring/10',
